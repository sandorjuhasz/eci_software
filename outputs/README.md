...
`eci_comparisons_2020.csv` : for regressions to compare ECI software, trade, technology and research<br>
`data_entry_regressions_0011.csv` : dataframe for entry regressions <br>
`data_exit_regressions_0011.csv` : dataframe for exit regressions <br>
`data_exit_regressions_0011.csv` : dataframe for exit regressions <br>
`si_eci_software_2020_2023_ivreg.csv` : yearly complexity and related instruments based on GitHub data <br>
